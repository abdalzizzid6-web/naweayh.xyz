...
const INITIAL_SOCIAL_POSTS: SocialPostItem[] = [
  ...
  },
  {
    ...
    articleUrl: 'https://naweayh.xyz/news/adaptive-ai-smartphone-launch',
    category: 'تقنية',
    sourceName: 'رويترز الشرق الأوسط',
    country: 'عالمي',
    platform: 'Instagram',
